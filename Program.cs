namespace Match_Details_Management_System
{
    internal class Program
    {
        static void Main()
        {
            ...
            {
                Console.WriteLine("\nMenu:");
                Console.WriteLine("1. Display All  the Matches");
                Console.WriteLine("2. Display list of all Match Details");
                Console.WriteLine("3. Update Match Scores");
                Console.WriteLine("4. Remove the Match");
                Console.WriteLine("5. Sort the Match");
                Console.WriteLine("6. Filter the Match");
                Console.WriteLine("7. Calculate Statistics");
                Console.WriteLine("8. Search Matchee");
